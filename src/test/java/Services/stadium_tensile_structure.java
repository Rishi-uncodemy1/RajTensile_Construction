...
public class stadium_tensile_structure {
	...
	void Access_STS() 
	{
		...
		Services.click();	   
	    WebElement Stadium =driver.findElement(By.xpath("(//li[@class=\"menu-item menu-item-type-post_type menu-item-object-page menu-item-14350\"])"));
	    Stadium.click();
	}
	@Test(priority=2)
