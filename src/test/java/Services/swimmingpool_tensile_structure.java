...
public class swimmingpool_tensile_structure {
		...
		void Access_SPTC() 
		{
			...
			Services.click();	   
		    WebElement SwimmingPool =driver.findElement(By.xpath("(//li[@class=\"menu-item menu-item-type-post_type menu-item-object-page menu-item-14345\"])"));
		    SwimmingPool.click();
		}
		@Test(priority=2)
