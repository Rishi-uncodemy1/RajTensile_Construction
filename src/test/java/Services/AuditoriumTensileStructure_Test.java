...
public class AuditoriumTensileStructure_Test
{
	...
	void Access_ATS() 
	{
		...
		Services.click();	   
	    WebElement Auditorium =driver.findElement(By.xpath("(//li[@class=\"menu-item menu-item-type-post_type menu-item-object-page menu-item-14327\"])"));
	    Auditorium.click();
	}
	@Test(priority=2)
