...
public class GazeeboTensileTest {
...
//	    Thread.sleep(3000);
       ...
       driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(10));
	    ...
	    driver.findElement(By.xpath("(//a[@class=\"elementor-sub-item\"])[4]")).click();
	 }	  
...
//    	  Thread.sleep(3000);
    	  ...
    	  WebElement imageforward = driver.findElement(By.xpath("//a[text()='Next']"));
    	  d=imageforward.isDisplayed();
    	  if (d=true) {
    	  action.moveToElement(imageforward).perform();
//    		  imageforward.click();   		  
    	  }
    	  else {
    		driver.navigate().refresh();    		  
...
//    	   Thread.sleep(3000);
    	   WebElement imageprevious = driver.findElement(By.xpath("//a[text()='Next']"));
    	   e=imageprevious.isDisplayed();
    	   if (d=true) {
    		 action.moveToElement(imageprevious).perform();
//     		  imageprevious.click();   		  
     	  }
     	  else {
     		  driver.navigate().refresh();    		  
