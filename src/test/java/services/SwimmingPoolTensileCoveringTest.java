...
public class SwimmingPoolTensileCoveringTest {
	...
	@Test(priority=2)
	void visibilitySwimmingPoolTensileCovering() throws InterruptedException {
		WebElement swimmingPoolTensileCovering = driver.findElement(By.xpath("(//a[@class='elementor-sub-item'])[5]"));
		a=swimmingPoolTensileCovering.isDisplayed();
		b=swimmingPoolTensileCovering.isEnabled();

		if(a==true && b==true) {
			swimmingPoolTensileCovering.click();
			Thread.sleep(2000);
			System.out.println("SwimmingPool Tensile Covering option is visible: "+a);
		}
		else {
			driver.navigate().refresh();
		}
	...
	void visibilityLogo() throws InterruptedException {
		WebElement logo = driver.findElement(By.xpath("//h1[normalize-space()='Swimming Pool Tensile Covering']"));
		a=logo.isDisplayed();
	...
	@Test(priority=4)
	void navigateSwimmingPoolTensileCovering() throws InterruptedException {
		WebElement services = driver.findElement(By.xpath("(//span[@class='sub-arrow'])[1]"));
		services.click();
		Thread.sleep(2000);
