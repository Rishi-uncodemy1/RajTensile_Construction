...
public class StadiumTensileStructureTest {
	...
	@Test(priority=2)
	void visibilityStadiumTensileStructure() throws InterruptedException {
		WebElement stadiumTensileStructure = driver.findElement(By.xpath("(//a[@aria-current='page'])"));
		a=stadiumTensileStructure.isDisplayed();
		b=stadiumTensileStructure.isEnabled();

		if(a==true && b==true) {
			stadiumTensileStructure.click();
			Thread.sleep(2000);
			System.out.println("Stadium Tensile Structure option is visible: "+a);
		}
		else {
			driver.navigate().refresh();
		}
	...
	void visibilityLogo() throws InterruptedException {
		WebElement logo = driver.findElement(By.xpath("(//span[@class='sub-arrow'])[1]"));
		a=logo.isDisplayed();
	...
	@Test(priority=4)
	void navigateStadiumTensileStructure() throws InterruptedException {
		WebElement services = driver.findElement(By.xpath("(//span[@class='sub-arrow'])[1]"));
		services.click();
		Thread.sleep(2000);
